...
public function addUserFunc($email, $firstName, $middleIn, $lastName, $phoneNum, $birthday, $username, $password, $rolesID = 2) {
        try {
            ...
            if ($this->regsModel->createRegistration($email, $firstName, $middleIn, $lastName, $phoneNum, $birthday, $username, $hashedPassword, $rolesID)) {
