...
class RegistrationModel {
    ...
    public function createRegistration($email, $fName, $middleIn, $lName, $phoneNum, $birthday, $username, $hashedPassword, $rolesID = 2): bool {
        $query = "INSERT INTO tbl_users
                    (rolesID, users_email, users_firstName, users_middleIn,
                     users_lastName, users_phoneNum, users_birthday,
                     users_username, users_password)
                  VALUES
                    (:rolesID, :email, :firstName, :middleIn,
